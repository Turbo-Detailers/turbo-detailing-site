...
function ContactPage({ isFirstMount }: Props) {
  return (
    <>
      <motion.section exit={{ opacity: 0 }}>
        <Head>
          ...
          <meta
            name="description"
            content="Contact us. If you have any questions about our detailing services, feel free to reach out to us using our form! We detail and provide detailing services in the Greater Twin Cities and Minneapolis area: Chaska, Chanhassen, Eden Prairie, Plymouth, Minnetonka, Wayzata, and more!"
          />
        ...
        <motion.main className={styles.main} initial="initial"
          ...
          <Spacer height={3} />
          <motion.div variants={pagecontents}>
            <ContactForm />
            <Spacer height={2} />
